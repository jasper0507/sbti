...
const TYPE_LIBRARY = {
  ZB8: {
    ...
    image: "image/types/zb8.png",
    careers: ["寝室—教室两点一线的「人体贴贴椅背」体验官", "短视频平台早八吐槽区野生 UP 主（未出道版）", "午睡恢复协议首席谈判代表"],
  },
  "1T4": {
    code: "1T4",
    cn: "小组大怨种",
    ...
    image: "image/types/1t4.png",
    careers: ["小组作业「缝补师」：专收百度百科超链接事故", "PPT 急诊室夜班大夫", "微信群「好的没问题」表情包供应商"],
  },
  BL8: {
    code: "BL8",
    cn: "摆烂吧！",
    ...
    image: "image/types/bl8.png",
    careers: ["明日复明日战略研究院（编制：0）", "期末周临时肝帝事务所合伙人", "自我原谅学 · 荣誉本科生"],
  },
  SXY: {
    code: "SXY",
    cn: "自习室咸鱼",
    ...
    image: "image/types/sxy.png",
    careers: ["自习室占座行为艺术策展人", "奶茶驱动型知识观光客", "效率口号复读机（仅外放）"],
  },
  TDL: {
    code: "TDL",
    cn: "拖到死",
    ...
    image: "image/types/tdl.png",
    careers: ["死线前 24h 超频战士", "参考文献最后两页终身成就奖候选人", "版本号 v999 文件命名学博士在读"],
  },
  GJ8: {
    code: "GJ8",
    cn: "遥想公瑾！",
    ...
    image: "image/types/gj8.png",
    careers: ["生活费蒸发术 · 现场见证者", "月底泡面续命协会荣誉会员", "遥想公瑾朗诵团（独幕剧）"],
  },
  JHBH: {
    code: "JHBH",
    cn: "身在豪中不知豪",
    ...
    image: "image/types/jhbh.png",
    careers: ["赛博黑客氛围组（敲键盘有声、输出看缘）", "校园低调走秀社（观众：自己）", "暗恋观察笔记绝密档案管理员"],
  },
  YYDS: {
    code: "YYDS",
    cn: "永远滴神！",
    intro:
      '食堂多给了一勺肉就能在朋友圈封神，室友帮忙带杯奶茶直接跪喊"YYDS"，就连网课没卡顿都觉得是老天爷亲儿子待遇——你嘴里的"永远滴神"廉价到批发，但你那股真诚到夸张的崇拜劲儿，让被吹的人一边嫌弃一边忍不住嘴角上扬。',
    desc: "你的快乐阈值低到地板，感动能力强到天花板：别人帮你带个快递就能原地封神，食堂阿姨多给一勺肉就是年度最佳。你不是没见过世面，是真心觉得每一个小确幸都值得「封神仪式」。保持这种能力，你会活得很开心。",
    image: "",
    careers: ["万物皆可 YYDS 认证官", "夸夸群自动回复机器人", "自来水安利永动机"],
  },
  XSWL: {
    code: "XSWL",
    cn: "笑死我了",
    intro:
      '群聊里最后一个发文字消息的人是你，但第一个发表情包的永远也是你。你用笑声盖过一切尴尬、紧张和社恐，三句话不离"笑死""绷不住了""哈哈哈"，其实内心可能正在社恐发作，但没人发现——因为你的表情包已经替你社交完毕了。',
    desc: "你是用笑声武装的社交达人：场面冷了你抛梗，话题断了你发图，社恐犯了你哈哈。表面上是你带动全场气氛，实际上是表情包替你完成了所有社交任务。笑声是你的盔甲，梗图是你的盾牌，谁也别想让你的社恐暴露在阳光下。",
    image: "",
    careers: ["表情包投喂专业户（不产出只转发）", "冷场救火队编外成员", "笑声传染防控重点人员"],
  },
  NBHD: {
    code: "NBHD",
    cn: "你不好带",
    intro:
      '老师讲 PPT 刚翻到第三页，你的手已经举起来了——"但是我觉得这个论证有问题"。群里有人发养生谣言你第一个开杠，室友选了部烂片你要分析半小时哪里烂，小组讨论永远有人被你气到翻白眼，但事后冷静下来又发现你说得好像还真有点道理。',
    desc: "你不好带，但你带的路通常是对的。别人看到规则会遵守，你看到规则会想「为什么」；别人随大流，你偏要逆流。你不是抬杠，是控制不住地想把事情想清楚——只是「想清楚」这个过程经常会让别人不太舒服。你的魅力需要时间被发现。",
    image: "",
    careers: ["课堂抬杠指定辩手", "「但是我觉得」口头禅患者", "魔鬼代言人（未受邀版）"],
  },
  XDJM: {
    code: "XDJM",
    cn: "兄弟姐妹遍天下",
    intro:
      '走到哪都像回老家，刚进社团第二天就和副社长称兄道弟，选课群里第一个发"有没有一起的姐妹"，食堂打饭都能和阿姨唠两句家常。你的微信好友数直逼五千，朋友圈点赞量遥遥领先，但真到了需要借笔记的深夜，你翻遍列表发现大多数人只是「通讯录里的熟人」。',
    desc: "你的社交网络像蒲公英：种子撒得广，落地却未必扎根。你真诚地对每一个新朋友喊「兄弟姐妹」，但真正能半夜回你消息的可能还是那两三个老友。你的热情是真的，人脉也是真的，只是人脉和知己之间还隔着一段需要时间才能走完的路。",
    image: "",
    careers: ["全校社团人脉收割机", "微信好友 5000 但备注全靠猜", "社交蝴蝶·聚会发起永动机"],
  },
  "6L6": {
    code: "6L6",
    cn: "六题六不像",
    ...
    image: "",
    careers: ["啥都沾点啥都不精的「综合型大学牲」", "下一题也许就露馅的薛定谔人设", "适合把本页截图发群问：所以我到底是哪种有病"],
  },
};

/** 从 TYPE_LIBRARY 动态生成（6L6 为兜底，不参与计分） */
const STTI_KEYS = Object.keys(TYPE_LIBRARY).filter((k) => k !== "6L6");
...
const QUESTIONS = [
  {
    ...
    options: [
      { label: "已进入冲刺模式：拆模块、赶进度，先保证能交、尽量像样", scores: [-1.1, -0.3, 0.9, 1.1], stti: { TDL: 1.8, "1T4": 1.2, BL8: -0.2, NBHD: 1.8 } },
      { label: "大脑保护性宕机：先躺一阵，相信「最后总会有办法」", scores: [-0.4, -0.4, -0.6, -0.9], stti: { ZB8: 2.8, BL8: 1.4, YYDS: 1.6, XDJM: 1.4 } },
      { label: "知道该动笔，但先刷手机、收拾桌面——「再开始就写」", scores: [1.0, 0.4, -0.5, -0.9], stti: { BL8: 2.2, SXY: 1.6, GJ8: 0.5, XSWL: 1.6, XDJM: 1.0 } },
    ],
  },
  {
    id: "q2",
    ...
    options: [
      { label: "先听完别人怎么说，到我讲讲事实就行，短一点更好", scores: [-1.0, -0.5, 0.2, -0.2], stti: { JHBH: 1.4, SXY: 0.8, YYDS: 1.4 } },
      { label: "希望快点结束，最好别即兴提问，我只想当背景板", scores: [-1.6, -0.3, -0.4, -0.2], stti: { JHBH: 2.4, ZB8: 0.5, BL8: 0.5, NBHD: 2.0 } },
      { label: "顺势抛个梗热场，下场围观大家的反应也挺好玩", scores: [1.3, 0.7, -0.1, -0.5], stti: { GJ8: 1.6, JHBH: 0.6, XSWL: 2.6, XDJM: 1.8 } },
    ],
  },
  {
    id: "q3",
    ...
    options: [
      { label: "硬核主线：竞赛、科研或大考路线，长了点但能写进履历", scores: [-0.2, 1.0, 1.1, 1.0], stti: { "1T4": 2.4, TDL: 0.9, BL8: -0.4, XDJM: 1.6, NBHD: 1.2 } },
      { label: "人气支线：自媒体、摆摊、社团门面——重在曝光和连接", scores: [1.2, -0.3, -0.5, -0.2], stti: { GJ8: 2.4, SXY: 1.0, BL8: 0.5, XSWL: 2.0, YYDS: 1.4 } },
      { label: "回血支线：少社交多独处，散步发呆也行，先把电量补回来", scores: [-1.3, -0.2, -0.4, -0.7], stti: { BL8: 1.8, JHBH: 1.2, ZB8: 0.6, XDJM: 1.4 } },
    ],
  },
  {
    id: "q4",
    ...
    options: [
      { label: "复盘备忘录：下次别再栽在同一个坑里", scores: [-0.1, -0.5, 1.1, 1.0], stti: { "1T4": 2.2, TDL: 0.8, NBHD: 2.0 } },
      { label: "记住教训就够了，细节不深挖，往前走", scores: [0.0, 0.5, -0.3, -0.1], stti: { SXY: 1.6, XDJM: 1.2 } },
      { label: "主要靠时间冲淡，当没发生过也行", scores: [-0.5, 0.3, -0.7, -0.8], stti: { BL8: 2.0, ZB8: 0.8, JHBH: 0.5, XSWL: 1.4, YYDS: 1.6 } },
    ],
  },
  {
    id: "q5",
...
function pickTags(answers, acc, sttiCode) {
  ...
  if (sttiCode === "YYDS") tags.push("万物皆可封神");
  if (sttiCode === "XSWL") tags.push("表情包永动机");
  if (sttiCode === "NBHD") tags.push("抬杠艺术家");
  if (sttiCode === "XDJM") tags.push("人脉收割机");
...
function computeAndRenderResult() {
  ...
  const careers = twin.careers || TYPE_LIBRARY["6L6"].careers;
...
function renderGallery() {
  ...
  const allKeys = Object.keys(TYPE_LIBRARY);
  grid.innerHTML = "";
